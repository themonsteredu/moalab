/**
 * 서버 껍데기 — 내용은 전부 RevenueMonthScreen(클라이언트) 이 그린다.
 *
...
import RevenueMonthScreen from './RevenueMonthScreen';

export default function Page() {
  return (
    <Suspense fallback={<p className="p-10 text-center text-[14px] text-neutral-500">계산안을 불러오고 있어요…</p>}>
      <RevenueMonthScreen />
    </Suspense>
  );
}
