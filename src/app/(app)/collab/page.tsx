 ...
 *
 * 내 부서는 **부서업무에서 파생한다** — 팀장이거나, 그 부서 역할의 주담당·부담당이면
        ...
        {depts !== null && noDept && (
          <div className="card mb-3 border-brand/30 bg-brand-50 p-3.5">
            ...
            <p className="mt-1 text-[12.5px] leading-relaxed text-neutral-600">
              <b>부서업무</b> 에서 역할의 담당자로 내 이름을 넣거나, 원장님이 부서 <b>팀장</b> 으로
            ...
            {(() => {
              ...
              return to.head_id ? (
                ...
                <p className="mt-1.5 text-[11.5px] text-brand">
                  이 부서에 팀장이 없어서 <b>원장님</b> 에게 알림이 갑니다. (부서업무에서 팀장을 정할 수 있어요)
                </p>
              );
            })()}
          </div>
